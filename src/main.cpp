...
void directLED(int direct, byte red, byte green, byte blue)
{
  red = constrain(red, 0, 15);
  green = constrain(green, 0, 15);
  blue = constrain(blue, 0, 15);

  int whichbyte = int(direct / 8);

  int wholebyte = direct;
...
void decodeBase64ToRGB(const char *base64String)
{
  ...
  {
    int decimal_number = i / 4;

    int z = (decimal_number / 64) % 8;
    int y = (decimal_number / 8) % 8;
    int x = decimal_number % 8;
    ...
    uint8_t r = combined & 0xFF;

    // Print RGB values
    // printf("RGB %3u: %3u, %3u, %3u, %3u, %3u, %3u\n", decimal_number, r, g, b, z, y, x);
    // directLED(decimal_number, r, g, b);
    LED(z, y, x, r, g, b);
  }
}
// end decode base64 //
...
void streamCallback(MultiPathStream stream)
{
  ...
  for (size_t i = 0; i < numChild; i++)
  {
    ...
    if (stream.get(childPath[i]))
    {
      ...
      {
        base64String = stream.value.c_str();
...
{
  // huruf B
  LED(6, row, 4 + shift, 15, 15, 0);
  LED(6, row, 3 + shift, 15, 15, 0);
  LED(6, row, 1 + shift, 15, 15, 0);
  LED(6, row, 2 + shift, 15, 15, 0);

  LED(5, row, 4 + shift, 15, 15, 0);
  LED(4, row, 4 + shift, 15, 15, 0);
  LED(3, row, 4 + shift, 15, 15, 0);
  LED(2, row, 4 + shift, 15, 15, 0);
  LED(1, row, 4 + shift, 15, 15, 0);
  LED(0, row, 4 + shift, 15, 15, 0);

  LED(3, row, 1 + shift, 15, 15, 0);
  LED(3, row, 2 + shift, 15, 15, 0);
  LED(3, row, 3 + shift, 15, 15, 0);

  LED(0, row, 1 + shift, 15, 15, 0);
  LED(0, row, 2 + shift, 15, 15, 0);
  LED(0, row, 3 + shift, 15, 15, 0);

  LED(5, row, 0 + shift, 15, 15, 0);
  LED(4, row, 0 + shift, 15, 15, 0);
  LED(2, row, 0 + shift, 15, 15, 0);
  LED(1, row, 0 + shift, 15, 15, 0);
...
{
  LED(6, row, 0 + shift, 0, 0, 15);
  LED(6, row, 1 + shift, 0, 0, 15);
  LED(6, row, 2 + shift, 0, 0, 15);
  LED(6, row, 3 + shift, 0, 0, 15);
  LED(6, row, 4 + shift, 0, 0, 15);

  LED(5, row, 2 + shift, 0, 0, 15);
  LED(4, row, 2 + shift, 0, 0, 15);
  LED(3, row, 2 + shift, 0, 0, 15);
  LED(2, row, 2 + shift, 0, 0, 15);
  LED(1, row, 2 + shift, 0, 0, 15);

  LED(0, row, 0 + shift, 0, 0, 15);
  LED(0, row, 1 + shift, 0, 0, 15);
  LED(0, row, 2 + shift, 0, 0, 15);
  LED(0, row, 3 + shift, 0, 0, 15);
  LED(0, row, 4 + shift, 0, 0, 15);
}

void hurufN(int row, int shift)
{
  LED(6, row, 0 + shift, 15, 0, 0);
  LED(5, row, 0 + shift, 15, 0, 0);
  LED(4, row, 0 + shift, 15, 0, 0);
  LED(3, row, 0 + shift, 15, 0, 0);
  LED(2, row, 0 + shift, 15, 0, 0);
  LED(1, row, 0 + shift, 15, 0, 0);
  LED(0, row, 0 + shift, 15, 0, 0);

  LED(4, row, 3 + shift, 15, 0, 0);
  LED(3, row, 2 + shift, 15, 0, 0);
  LED(2, row, 1 + shift, 15, 0, 0);

  LED(6, row, 4 + shift, 15, 0, 0);
  LED(5, row, 4 + shift, 15, 0, 0);
  LED(4, row, 4 + shift, 15, 0, 0);
  LED(3, row, 4 + shift, 15, 0, 0);
  LED(2, row, 4 + shift, 15, 0, 0);
  LED(1, row, 4 + shift, 15, 0, 0);
  LED(0, row, 4 + shift, 15, 0, 0);
}

void hurufU(int row, int shift)
{
  LED(6, row, 0 + shift, 0, 0, 15);
  LED(5, row, 0 + shift, 0, 0, 15);
  LED(4, row, 0 + shift, 0, 0, 15);
  LED(3, row, 0 + shift, 0, 0, 15);
  LED(2, row, 0 + shift, 0, 0, 15);
  LED(1, row, 0 + shift, 0, 0, 15);
  ...
  LED(6, row, 4 + shift, 0, 0, 15);
  LED(5, row, 4 + shift, 0, 0, 15);
  LED(4, row, 4 + shift, 0, 0, 15);
  LED(3, row, 4 + shift, 0, 0, 15);
  LED(2, row, 4 + shift, 0, 0, 15);
  LED(1, row, 4 + shift, 0, 0, 15);
}
...
void hurufS(int row, int shift)
{
  ...
  LED(3, row, 1 + shift, 0, 0, 15);
  LED(3, row, 2 + shift, 0, 0, 15);
  LED(3, row, 3 + shift, 0, 0, 15);
...
void displayFrame()
{
  while (on)
  {
    ...
    {
      clean();
      const char *toRGB = base64String.c_str();
      decodeBase64ToRGB(toRGB);
...
void setup()
{
  ...
  // int timerScale = 800;
  // SETTINGS//
  // Bright : 800 - 80 : Flicker-free
  My_timer = timerBegin(0, 80, true);
  timerAttachInterrupt(My_timer, &onTimer, true);
  timerAlarmWrite(My_timer, 200, true); // DO NOT CHANGE
